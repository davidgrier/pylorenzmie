...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.alpha = QParameterWidget(self.parameterFrame)
        self.alpha.setFrameShape(QtWidgets.QFrame.Panel)
        self.alpha.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.alpha.setObjectName("alpha")
        self.gridLayout.addWidget(self.alpha, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.alpha.setStatusTip(_translate("MainWindow", "x coordinate [pixel]"))
